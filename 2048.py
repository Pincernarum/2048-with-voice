...
class Game(tk.Frame):
    ...
    def speak(self, event):
        ...
        try:
            ...
            if "up" in command:
                ...
                self.restart_game()
                command = ""
            elif "end" in command or "exit" in command or "quit" or 'end' in command:
                self.quit()
            else: 
                engine.say("Wrong command")
                engine.runAndWait()
        except:
            engine.say("I can't hear you")
            engine.runAndWait()
    ...
    def make_GUI(self):
        ...
        score_frame.place(relx=0.5, y=42, anchor="center")
        tk.Label(
            score_frame,
            text="Score",
        ...
        reset_frame.place(relx=0.5, y=560, anchor="center")
        self.reset_button = tk.Button(
            reset_frame, text="Reset", font="Helvetica", width=15, height=1, command=self.restart_game)
